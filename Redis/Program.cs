...
namespace Redis
{
    ...
    class Program
    {
        ...
        {
            var connectionString = "garyredistest.redis.cache.windows.net:6380,password=YORQR8LirRO2Ybska77w2Qtax51tvp3peAzCaOxzsT4=,ssl=True,abortConnect=False";
            _redisConnection = await RedisConnection.InitializeAsync(connectionString);
